    ...
    for (let i = 0; i < dataFiles.length; i += CHUNK) {
      ...
      for (const file of chunk) {
        try {
          ...
          // Skip known non-chat Facebook metadata files (HTML and JSON)
          ...
          // Skip .txt files inside Facebook export folders (file attachments, not WhatsApp chats)
          ...
          // Capture "Generated by" name from HTML exports — most reliable auto-detect
          if (result.generatedBy && !detectedOwnerName) {
            detectedOwnerName = result.generatedBy;
          }

          // Track participants across threads for auto-detection of "self"
